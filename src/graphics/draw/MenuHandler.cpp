...
{
    enum optionsNumbers { Back = 0, ViewMode, DeleteMenu, ReplyMenu, PagerMode, MuteChannel, Aloud, enumEnd };
    ...
    if (mode != graphics::MessageRenderer::ThreadMode::ALL) {
        optionsArray[options] =
            graphics::MessageRenderer::isPagerModeEnabled() ? "Disable Pager Mode" : "Enable Pager Mode";
        optionsEnumArray[options++] = PagerMode;
    }
    ...
    bannerOptions.bannerCallback = [](int selected) -> void {
        ...
        } else if (selected == PagerMode) {
            graphics::MessageRenderer::togglePagerMode();
            screen->showSimpleBanner(graphics::MessageRenderer::isPagerModeEnabled() ? "Pager Mode\nOn" : "Pager Mode\nOff",
                                     1200);
