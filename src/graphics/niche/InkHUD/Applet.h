...
class Applet : public GFX
{
  public:
    ...
    virtual bool supportsPagerMode() const { return false; }
    virtual bool isPagerModeEnabled() const { return false; }
    virtual void setPagerMode(bool enabled) { (void)enabled; }
